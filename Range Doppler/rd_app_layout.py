...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.range_doppler_label.setStyleSheet("color: white;")
        left_plot_layout.addWidget(self.range_doppler_label)
        
        # Range doppler view
        self.range_doppler_view = GraphicsLayoutWidget(self.centralwidget)
        self.range_doppler_view.setObjectName("range_doppler_view")
        self.range_doppler_view.setBackground('black')
        self.range_doppler_view.setStyleSheet("border: 2px solid white;")
        self.range_doppler_view.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        self.range_doppler_view.setMinimumSize(400, 300)
        left_plot_layout.addWidget(self.range_doppler_view)
        ...
        # Set up table columns for range-doppler data
        self.data_display_table.setColumnCount(3)
        self.data_display_table.setHorizontalHeaderLabels(['Range (m)', 'Speed (m/s)', 'Direction'])
        ...
        self.guard_cells_spin.setValue(3)
        ...
        self.training_cells_spin.setValue(12)
        ...
        self.false_alarm_spin.setRange(0.0001, 1.0)
        self.false_alarm_spin.setSingleStep(0.0001)
        self.false_alarm_spin.setDecimals(4)  # Set to display 4 decimal places
        self.false_alarm_spin.setValue(0.0001)
        ...
        self.group_peaks_button.setChecked(True)
        ...
        self.remove_clutter_button.setChecked(True)
        ...
        for option in padding_options:
            ...
            self.doppler_pad_select.addItem(option)

        # Set default values
        self.window_select.setCurrentText("Hamming")
        self.range_pad_select.setCurrentText("256")
        self.doppler_pad_select.setCurrentText("64")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.doppler_pad_select.setToolTip(_translate("MainWindow", "Select doppler dimension padding"))
        MainWindow.setWindowTitle(_translate("MainWindow", "Real-Time Radar"))
        self.range_doppler_label.setText(_translate("MainWindow", "Range Doppler"))
